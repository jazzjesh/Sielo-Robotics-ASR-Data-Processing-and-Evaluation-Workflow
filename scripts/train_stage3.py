...
CSV_PATH = Path("data/stage3/data.csv")
STAGE2_ADAPTER_DIR = Path("models/stage2_adapter")
OUTPUT_DIR = Path("models/stage3_adapter")
...
def main():
    ...
    stage2_model = PeftModel.from_pretrained(base_model, str(STAGE2_ADAPTER_DIR)).to(device)
    ...
    print(f"Saved Stage 3 adapter to: {OUTPUT_DIR}")
